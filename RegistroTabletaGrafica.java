...
public class RegistroTabletaGrafica {
    ...
    public LinkedList<Tableta_Grafica> registroTabletaGrafica (LinkedList<Tableta_Grafica> ListaTG){
        ...
        float tamano = 0, precio = 0, peso = 0;
            ...
            jp.showMessageDialog(null, "Datos de la tableta");
            tb.setSerial(jp.showInputDialog(null, "Ingrese el serial de la tableta: "));
            tb.setMarca(jp.showInputDialog(null, "Ingrese la marca de la tableta: "));
    ...
    public String menuAlmacenamiento(int opcionDi){
        ...
        opcionDi = Integer.parseInt(jp.showInputDialog(menu));
        ...
        switch (opcionDi) {
            ...
            case 3:
                return "1 TB";
            default:
                jp.showMessageDialog(null, "Opcion Invalida. Se le asignara 256 GB por defecto");
                return "256 GB";
        }
    }
